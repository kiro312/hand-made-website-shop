<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="user_first_name" class="block mt-1 w-full" type="text" name="user_first_name"
        ...
        <div>
            ...
            <x-text-input id="user_last_name" class="block mt-1 w-full" type="text" name="user_last_name"
        ...
        <div>
            ...
            <x-text-input id="user_phone" class="block mt-1 w-full" type="text" name="user_phone" :value="old('user_phone')"
                required autofocus />
